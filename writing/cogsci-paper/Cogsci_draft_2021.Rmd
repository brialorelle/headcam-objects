...
```{r anim_size, echo=F, include = T, fig.env = "figure", fig.pos = "h", fig.align='center', fig.width=3, fig.height=4.5, set.cap.width=T, num.cols.cap=1, fig.align = "center", fig.cap = "Frequency of animals (including toys) relative to big and small inanimate objects detected in the dataset."}
# Figure  3
...
Finally, we next examined the degree to which these broad categories appeared together in different frames. With some frequent activity context activities (i.e. mealtime) may have a fixed set of categories that are usually co-present (i.e. utensils/dishes and food), others may not be so easy to intuit. Figure X shows the co-occurance of the broad categories that were annotated 
