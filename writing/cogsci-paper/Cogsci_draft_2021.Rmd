...
```{r basic_levelexamples, include = T, fig.env = "figure", fig.pos = "h", fig.align='center', fig.width=3, set.cap.width=T, num.cols.cap=1, fig.align = "center", fig.cap = "Example frames with annotations of books and toys."}
